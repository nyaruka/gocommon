...
// pgx has types for scanning arrays, but they don't implement the Scanner interface required to use them with
// database/sql so this is basically a copy of pq.StringArray
